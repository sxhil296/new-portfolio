...
export const gridItems = [
  {
    id: 1,
    title:
      "I commit to working closely with clients and encouraging transparent conversations.",
    description: "",
  ...
  },
  {
    id: 2,
    title:
      "I am flexible with time zones to facilitate effective communication.",
    description: "",
  ...
  {
    id: 4,
    title: "Avid tech lover with a zeal for development.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a CLI tool",
  ...
  {
    id: 6,
    title: "Want to kick off a project together?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
